...
DEVICE = torch.device("cpu")  # Cambia a 'cuda' si tienes una GPU disponible
...
def load_dataset():
    df = pd.read_csv("/home/ubuntu/aprendizaje_federado/federated_working_powerZ_IBARMIA.csv")  # Actualiza con tu ruta
...
class Net(nn.Module):
    def __init__(self) -> None:
        ...
        self.fc1 = nn.Linear(6, 16)  # 8 características de entrada

...
strategy = FedAvg(
    ...
    fraction_evaluate=1.0,  # Solo el 50% de los clientes participarán en la ev>
    min_fit_clients=2,  # Se necesitan al menos 2 clientes para entrenar
    min_evaluate_clients=2,  # Al menos 1 cliente para evaluar
...
strategy = FedAvg(
    fraction_fit=1.0,  # El 100% de los clientes participarán en cada ronda de >
    fraction_evaluate=1.0,  # Solo el 50% de los clientes participarán en la ev>
    min_fit_clients=4,  # Se necesitan al menos 2 clientes para entrenar
    min_evaluate_clients=4,  # Al menos 1 cliente para evaluar
    min_available_clients=4,  # Se requieren al menos 2 clientes disponibles en>
    evaluate_metrics_aggregation_fn=weighted_average,
)
...
if __name__ == "__main__":
    ...
    fl.server.start_server(
        ...
        config=fl.server.ServerConfig(num_rounds=100),  # Configuración del servidor con 5 rondas
